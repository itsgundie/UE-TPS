...
# example of usage:
# tests_convert_report_for_jenkins.py -ue_report_path=D:\Jenkins\Jobs\UE_TPS\Build\Tests\index.json -junit_xml_path=D:\Jenkins\Jobs\UE_TPS\Build\Tests\index.xml
